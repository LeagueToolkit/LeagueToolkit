...
namespace Fantome.Libraries.League.IO.BIN
{
    public class BINValue : IBINValue, IEquatable<BINValue>
    {
            ...
            get
            {
                ...
                else if(property.Contains('[') && !property.Contains('.'))
                {
                    ...
                    if(this.Type == BINFileValueType.Container && 
                        ...
                        (this.Value as BINContainer).EntryType == BINFileValueType.Structure)
                    {
        ...
        public BINValue(IBINValue parent, uint property, object value, BINFileValueType type)
        {
            this.Parent = parent;
        ...
        public BINValue(BinaryReader br, IBINValue parent, BINFileValueType? type = null)
        {
            this.Parent = parent;
            this.Type = type;
            if (this.Type == null)
            ...
            if (this.Type == BINFileValueType.None)
            {
                this.Value = null;
            }
            ...
            else if (this.Type == BINFileValueType.OptionalData)
            {
        ...
        public uint GetSize()
        {
            ...
            switch (this.Type)
            {
                ...
                case BINFileValueType.OptionalData:
