...
{
    [IniProperty("skinID", typeof(uint))]
    public uint SkinID { get; set; }

    [IniProperty("Move", typeof(Vector3))]
    public Vector3 Translation { get; set; }

    [IniProperty("Rot", typeof(Vector3))]
    public Vector3 Rotation { get; set; }

    [IniProperty("mMaxHP", typeof(float))]
    public float MaxHP { get; set; }

    [IniProperty("mBaseStaticHPRegen", typeof(uint))]
    public uint BaseStaticHPRegen { get; set; }

    [IniProperty("mArmor", typeof(float))]
    public float Armor { get; set; }

    [IniProperty("mMaxMP", typeof(float))]
    ...
    public ObjectConfigObject(
        ...
        Vector3 rotation,
        float maxHP,
        uint baseStaticHPRegen,
        float armor,
        float maxMP,
        float selectionHeight,
        float selectionRadius,
        float selection_t1Radius,
        ...
        string voSkinName,
        bool swapModelOnDeathTime,
        string destroyedTowerSkin,
        uint destroyedTowerSkinID,
        Vector3 warningDecalOffset,
