...
namespace LeagueToolkit.IO.LightEnvironment
{
    public class LightEnvironmentLight
    {
        ...
        public Color Color { get; private set; } //*(v6 + 67) = (v38 << 16) | (v37 << 8) | v36 | 0xFF000000;
        public Color Color2 { get; private set; } //Not so sure about this one, seems to be a color *(v6 + 67) = (v38 << 16) | (v37 << 8) | v36 | 0xFF000000;
        ...
        public LightEnvironmentLight(StreamReader sr)
        {
            ...
            this.Color2 = new Color(byte.Parse(line[6]), byte.Parse(line[7]), byte.Parse(line[8]));
