...
public static class LeagueFile
{
    public static LeagueFileType GetFileType(ReadOnlySpan<byte> magicData)
    {
        ...
        {
            { Length: >= 8 } when magicData[..8].SequenceEqual("r3d2Mesh"u8) => LeagueFileType.StaticMeshBinary,
            { Length: >= 8 } when magicData[..8].SequenceEqual("r3d2sklt"u8) => LeagueFileType.Skeleton,
    ...
    public static string GetExtension(LeagueFileType extensionType)
    {
        return extensionType switch
        {
            ...
            LeagueFileType.RiotStringTable => "stringtable",
            LeagueFileType.SimpleSkin => "skn",
            LeagueFileType.Skeleton => "skl",
            LeagueFileType.StaticMeshAscii => "sco",
            LeagueFileType.StaticMeshBinary => "scb",
