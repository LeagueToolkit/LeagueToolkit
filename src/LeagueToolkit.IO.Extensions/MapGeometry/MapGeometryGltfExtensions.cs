    ...
    public static class MapGeometryGltfExtensions
    {
        ...
        private static readonly Dictionary<uint, IMaterialAdapter> MATERIAL_ADAPTERS =
            new()
            {
                ...
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Chemtech_Island"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Cloud_Island"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Earth_Island"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Generic_Island"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Infernal_Island"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Master"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/Environment/SRX_Blend_Ocean_Island"), new SrxBlendMaster() },
